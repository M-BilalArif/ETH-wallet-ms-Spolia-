invoice = {
...

	{
		...
		invoiceURL = "http://bitcoin.wallet.ms/request/" + document.location.hash;
		...
		$("title").html( "Bitcoin-Wallet " + htmlEncode( getTypeName( obj.type ) ) + " - " + htmlEncode( obj.title ) );



		$("meta[property='og\\:title']").attr("content", "Bitcoin-Wallet " + htmlEncode(getTypeName( obj.type )) + " - " + htmlEncode( obj.title ) );

		$("meta[property='og\\:description']").attr("content", "Bitcoin-Wallet " + htmlEncode(obj.description) + " - " + htmlEncode( obj.title ) );

		$("meta[name='description']").attr("content", "Bitcoin-Wallet " + htmlEncode(obj.description) + " - " + htmlEncode( obj.title ) );
...

	{
	    ...
	    $.ajax({
	        ...
	        url: "https://bitcoin.wallet.ms/ticker2.php",
...

{
...

	{
    	...
    	url='https://bitcoin.wallet.ms&display=popup&caption=' + encodeURIComponent("Bitcoin-Wallet " + getTypeName( invoice.invoiceType ) ) + '&name=' + encodeURIComponent( invoice.title ) + '&description=' + encodeURIComponent( invoice.description.substring(0,160) ) + '&link=' + invoice.shortURL + '&picture=' + encodeURIComponent( "http://bitcoin.wallet.ms/img/fb.png" ) + '&redirect_uri=http://bitcoin.wallet.ms/close.html';



    	popupwindow( url, "Share", 500, 300)
...

	{
	    ...
	    url='http://twitter.com/share?text=' + encodeURIComponent( invoice.title + " - " + " #Bitcoin-Wallet " + getTypeName( invoice.invoiceType )  ) + "&url=" + encodeURIComponent( invoice.shortURL ) ;
